                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        id="username"
                        name="username"
                        class="py-3 px-4 block w-full border-gray-200 dark:border rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
                        required
                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        class="py-3 px-4 block w-full dark:border border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"
                        required
